...
<body>
	...
	<div style="margin: 50px;">
		 <div class="panel panel-default">
			<div class="panel-body text-center">
					...
					<div class="form-group">
						<label for=""><h1 style="font-weight: bold; color: #999999;">反馈信息</h1></label> 
        ...
        <ul class="pagination">
            <%--首页--%>
            <li><a href="<%=basePath%>feedbackUser/selectFeedback?pn=1">首页</a></li>
                
            <%--下一页--%>
            <c:if test="${PageInfo.hasPreviousPage}">
                <li>
                    <a href="<%=basePath%>feedbackUser/selectFeedback?pn=${PageInfo.pageNum-1}" aria-label="Previous">
            ...
            <c:forEach items="${PageInfo.navigatepageNums}" var="pageshow">
                <c:if test="${pageshow == PageInfo.pageNum}">
                    <li class="active"><a href="<%=basePath%>feedbackUser/selectFeedback?pn=${pageshow}">${pageshow}</a></li>
                </c:if>
                <c:if test="${pageshow != PageInfo.pageNum}">
                    <li><a href="<%=basePath%>feedbackUser/selectFeedback?pn=${pageshow}">${pageshow}</a></li>
                </c:if>
            </c:forEach>
            ...
            <c:if test="${PageInfo.hasNextPage}">
                <li>
                    <a href="<%=basePath%>feedbackUser/selectFeedback?pn=${PageInfo.pageNum+1}" aria-label="Next">
            ...
            <%--尾页--%>
            <li><a href="<%=basePath%>feedbackUser/selectFeedback?pn=${PageInfo.pages}">尾页</a></li>
